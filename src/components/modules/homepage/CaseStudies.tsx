    ...
    <section className="py-10 lg:py-32">
      <div className="container">
        <div className="flex flex-col gap-6 text-center">
          <p className="font-medium">1M+ Active ePay Wallet Users</p>
            ...
            <div className="flex flex-col gap-10 border-border sm:flex-row lg:col-span-2 lg:border-r lg:pr-16 xl:pr-24">
              ...
              <div className="flex h-full flex-col justify-between gap-10">
                <q className="sm:text-xl">
                  With ePay Wallet, sending and receiving money is instant. Our
                  customers can pay bills, recharge mobiles, and transfer funds
                  securely within seconds—no long queues, no delays.
                </q>
            ...
            <div className="flex flex-col gap-10 border-border sm:flex-row lg:col-span-2 lg:border-r lg:pr-16 xl:pr-24">
              ...
              <div className="flex h-full flex-col justify-between gap-10">
                <q className="sm:text-xl">
                  ...
                  it’s paying salaries or sending refunds, everything happens in
                  just a few taps with complete transparency and security.
                </q>
                <div className="flex items-end gap-6">
                  <div className="flex flex-col gap-1">
                    <p className="text-lg font-semibold text-primary">
