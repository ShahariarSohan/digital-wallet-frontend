...
// Professional Wallet Loader Component
  ...
  return (
    ...
    >
      ...
      <div className="relative" style={{ width: size, height: size }}>
        ...
        <div
          className="absolute inset-2 rounded-full border-4 border-transparent border-b-green-900"
          style={{
        ...
        {/* Glowing effect */}
        <div
          className="absolute inset-0 rounded-full bg-green-500/5 animate-pulse"
          style={{ animationDuration: "2s" }}
        />
      </div>
